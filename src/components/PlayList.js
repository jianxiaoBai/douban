  ...
  render() {
    ...
    return (
      <View style={{width:width,height:height,paddingTop:25,backgroundColor:'#fff'}}>
        ...
        locked={false}
        >
          <View tabLabel='正在热映' style={{marginBottom:50}}><HotList navigation={this.props.navigation} /></View>
          <View tabLabel='即将上映' style={{marginBottom:50}}><SoonList navigation={this.props.navigation} /></View>
        </ScrollableTabView>
      </View>
    );
  }
